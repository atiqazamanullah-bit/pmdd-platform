...
from agents.prompts import SEMANTIC_SYSTEM_PROMPT

class SemanticAnalyzerAgent(BaseCognitiveAgent):
    """Agent 3: Semantic Analyzer."""
    
    def __init__(self):
        super().__init__(agent_name="Agent3_Semantic", max_retries=3)
    ...
    async def observe(self, state: CognitiveState) -> Dict[str, Any]:
        return {"memory": "Semantic context loaded."}
